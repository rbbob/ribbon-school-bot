...
"ワードとエクセルの勉強をしたいのですがどれくらいの費用と時間がかかりますか？ - **基本学習時間**： - ワード：16時間 - エクセル：16時間 - **MOS資格対策**：上記に加えさらに30時間 - **費用**：11,000 円(月謝月4回)" 
...
"フォトショップやイラストレーターも勉強したいのですが？ - **提供講座**： - 初心者から始めるフォトショップコース - 初心者から始めるイラストレーターコース- デザインスキルを基礎から学べます"
...
"ネットショップを自分で運営したいのですがパソコン初心者でも大丈夫でしょうか？ - はい、初心者でも大丈夫です - 段階的に学べるカリキュラムをご用意しています - 多くの方が初心者から独自のネットショップを立ち上げています - ネットショップ講座で基礎から学べます"
...
"子供向けの講座はありますか？ - はい、**キッズプログラミングスクール**があります - **学べる内容**： - タッチタイピング - Scratch - VisualProgramming - HTML - JavaScript - Python - PremierePro - AfterEffects - **補助制度**：大阪市内在住の小学5年生～中学3年生は、大阪市習い事・塾代助成事業の対象""補助金を利用できる講座はありますか？ - はい、以下の公的支援制度が利用できる講座があります： - 大阪府スキルアップ支援金 - 大阪市習い事・塾代助成事業 - 厚生労働省・教育訓練給付金 - 経済産業省中小企業庁【2024年度・令和6年度】IT導入補助金 - 特に生成AI活用・ChatGPT等・RPA・PowerPlatformなどの講座はIT導入補助金が活用可能 - 2024 年度IT補助金支援事業者に採択されています" 
"営業時間と休校日を教えてください- **営業時間**： - 水曜日～土曜日：午前10時～午後6時 - 日曜日：午前10時～午後5時 - **休校日**： - 毎週月曜日 - 毎週火曜日 - 祝祭日 - 詳細はカレンダーをご確認ください"
...
"コロナ対策はどうなっていますか？ - **実施している対策**： - 授業中のマスク着用- アルコール消毒液の設置 - 人との間隔を2ｍ確保 - 常時または適宜室内換気 - 空気清浄機（プラズマクラスター）の使用 - 受講生の安全を第一に考えた対応を行っています"
